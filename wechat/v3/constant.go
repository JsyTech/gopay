...
const (
	...
	v3ComplaintUpdateRefundProgress = "/v3/merchant-service/complaints-v2/%s/update-refund-progress" // 更新退款审批结果 POST
	...
	// 银行组件
	v3BanksPersonalBanking  = "/v3/capital/capitallhh/banks/personal-banking"  // 查询支持个人业务的银行列表 GET
